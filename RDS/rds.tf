...
# resource "aws_rds_cluster_endpoint" "reading" {
#   cluster_identifier          = aws_rds_cluster.rds_claster.id
#   cluster_endpoint_identifier = "reader"
#   custom_endpoint_type        = "READER"

#   static_members = [
#     element(aws_rds_cluster_instance.reader.*.id, 0),
#     element(aws_rds_cluster_instance.reader.*.id, 1),
#     element(aws_rds_cluster_instance.reader.*.id, 2),
#   ]
# }
